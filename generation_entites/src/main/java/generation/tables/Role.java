...
public class Role extends TableImpl<RoleRecord> {
    ...
    /**
     * The column <code>public.role.nom</code>.
     */
    public final TableField<RoleRecord, String> NOM = createField(DSL.name("nom"), SQLDataType.VARCHAR(64).nullable(false), this, "");

    /**
     * The column <code>public.role.description</code>.
     */
    public final TableField<RoleRecord, String> DESCRIPTION = createField(DSL.name("description"), SQLDataType.VARCHAR(64), this, "");
